...
{t:'D', id:'1a', g:null, x:'в межах до 50 %',  c:'p', st:1, u:'%', pg:-1.4, pt:-1.88, pr:2.4},
{t:'D', id:'1b', g:null, x:'в межах 50–55 %',  c:'p', st:1, u:'%', pg:-1.2, pt:-1.61, pr:2.0},
{t:'D', id:'1c', g:null, x:'в межах 55–60 %',  c:'p', st:1, u:'%', pg:-1.0, pt:-1.34, pr:1.7},
...
{t:'D', id:'6a', g:'6', x:'при [S] у чавуні від 0,05 до 0,04 %', c:'p', st:0.1, u:'%', pg:-0.18, pt:-0.24, pr:0.18},
{t:'D', id:'6b', g:'6', x:'при [S] у чавуні від 0,04 до 0,03 %', c:'p', st:0.1, u:'%', pg:-0.22, pt:-0.29, pr:0.22},
{t:'D', id:'6c', g:'6', x:'при [S] у чавуні від 0,03 до 0,02 %', c:'p', st:0.1, u:'%', pg:-0.27, pt:-0.36, pr:0.27},
{t:'D', id:'6d', g:'6', x:'при [S] у чавуні від 0,02 до 0,01 %', c:'p', st:0.1, u:'%', pg:-0.38, pt:-0.52, pr:0.38},
{t:'D', id:'6e', g:'6', x:'при [S] у чавуні до 0,01 %', c:'p', st:0.1, u:'%', pg:-0.71, pt:-0.95, pr:0.71},
...
{t:'D', id:'7a', g:null, x:'за показником CSR: в межах до 45 %',                   c:'p', st:1, u:'%', pg:-0.93, pt:-1.21, pr:0.52},
{t:'D', id:'7b', g:null, x:'за показником CSR: в межах 45–52 %',                   c:'p', st:1, u:'%', pg:-0.54, pt:-0.70, pr:0.49},
{t:'D', id:'7c', g:null, x:'за показником CSR: в межах 52–58 %',                   c:'p', st:1, u:'%', pg:-0.31, pt:-0.38, pr:0.43},
{t:'D', id:'7d', g:null, x:'за показником CSR: в межах понад 58 %',                c:'p', st:1, u:'%', pg:-0.16, pt:-0.19, pr:0.35},
...
{t:'D', id:'15a', g:null, x:'800–900 °С',   c:'p', st:10, u:'°С', pg:-0.50, pt:-0.67, pr:0.50},
{t:'D', id:'15b', g:null, x:'900–1000 °С',  c:'p', st:10, u:'°С', pg:-0.40, pt:-0.54, pr:0.40},
{t:'C', x:'<em>а) при концентрації кисню в дутті до 25 %</em>'},
{t:'D', id:'15c', g:null, x:'1000–1100 °С', c:'p', st:10, u:'°С', pg:-0.30, pt:-0.40, pr:0.30},
{t:'D', id:'15d', g:null, x:'1100–1200 °С', c:'p', st:10, u:'°С', pg:-0.28, pt:-0.38, pr:0.28},
{t:'D', id:'15e', g:null, x:'1200–1300 °С', c:'p', st:10, u:'°С', pg:-0.25, pt:-0.34, pr:0.25},
{t:'D', id:'15f', g:null, x:'1300–1400 °С', c:'p', st:10, u:'°С', pg:-0.22, pt:-0.29, pr:0.22},
{t:'C', x:'<em>б) при концентрації кисню в дутті 25–35 %</em>'},
{t:'D', id:'15g', g:null, x:'1000–1100 °С', c:'p', st:10, u:'°С', pg:-0.25, pt:-0.34, pr:0.25},
{t:'D', id:'15h', g:null, x:'1100–1200 °С', c:'p', st:10, u:'°С', pg:-0.22, pt:-0.29, pr:0.22},
{t:'D', id:'15i', g:null, x:'1200–1300 °С', c:'p', st:10, u:'°С', pg:-0.20, pt:-0.27, pr:0.20},
{t:'D', id:'15j', g:null, x:'1300–1400 °С', c:'p', st:10, u:'°С', pg:-0.18, pt:-0.24, pr:0.18},
{t:'C', x:'<em>в) при концентрації кисню в дутті 35–40 %</em>'},
{t:'D', id:'15k', g:null, x:'1000–1100 °С', c:'p', st:10, u:'°С', pg:-0.20, pt:-0.27, pr:0.20},
{t:'D', id:'15l', g:null, x:'1100–1200 °С', c:'p', st:10, u:'°С', pg:-0.18, pt:-0.24, pr:0.18},
{t:'D', id:'15m', g:null, x:'1200–1300 °С', c:'p', st:10, u:'°С', pg:-0.16, pt:-0.21, pr:0.16},
{t:'D', id:'15n', g:null, x:'1300–1400 °С', c:'p', st:10, u:'°С', pg:-0.14, pt:-0.19, pr:0.14},
...
{t:'D', id:'17a', g:null, x:'до 25 %',  c:'p', st:1, u:'%', pg:0.50, pt:0.67, pr:2.0},
{t:'D', id:'17b', g:null, x:'25–30 %',  c:'p', st:1, u:'%', pg:0.80, pt:1.07, pr:1.7},
{t:'D', id:'17c', g:null, x:'30–35 %',  c:'p', st:1, u:'%', pg:1.10, pt:1.47, pr:1.4},
{t:'D', id:'17d', g:null, x:'35–40 %',  c:'p', st:1, u:'%', pg:1.40, pt:1.88, pr:1.1},
...
// ─────────── КОЛИВАННЯ СКЛАДУ ШИХТИ ТА ПАРАМЕТРІВ ПЛАВКИ (Табл. 3) ───────────
{t:'S', x:'Коливання складу шихти та параметрів плавки (Табл. 3) <sup>4)</sup>'},

{t:'R', n:'К1', id:'k1', g:null, x:'Зниження σ вологості коксу на кожні 0,1 %',           c:'s', st:0.1,  u:'%',   pg:-0.28, pt:-0.28, pr:0.42},
{t:'R', n:'К2', id:'k2', g:null, x:'Зниження σ похибки дозування шихти на кожні 0,1 %',    c:'s', st:0.1,  u:'%',   pg:-0.28, pt:-0.28, pr:0.42},
{t:'R', n:'К3', id:'k3', g:null, x:'Зниження σ зольності коксу на кожні 0,1',              c:'s', st:0.1,  u:'',    pg:-0.36, pt:-0.36, pr:0.54},
{t:'R', n:'К4', id:'k4', g:null, x:'Зниження σ вмісту заліза в шихті на кожні 0,1 %',      c:'s', st:0.1,  u:'%',   pg:-0.20, pt:-0.20, pr:0.29},

{t:'F', n:'К5', s:5, x:'Зниження σ основності шихти на кожні 0,01 од.'},
{t:'D', id:'k5a', g:'k5', x:'при виході шлаку 300–350 кг/т чавуну',  c:'s', st:0.01, u:'од.', pg:-0.13,  pt:-0.13,  pr:0.22},
{t:'D', id:'k5b', g:'k5', x:'при виході шлаку 350–400 кг/т чавуну',  c:'s', st:0.01, u:'од.', pg:-0.15,  pt:-0.15,  pr:0.257},
{t:'D', id:'k5c', g:'k5', x:'при виході шлаку 400–450 кг/т чавуну',  c:'s', st:0.01, u:'од.', pg:-0.17,  pt:-0.17,  pr:0.293},
{t:'D', id:'k5d', g:'k5', x:'при виході шлаку 450–500 кг/т чавуну',  c:'s', st:0.01, u:'од.', pg:-0.19,  pt:-0.19,  pr:0.33},

{t:'R', n:'К6', id:'k6', g:null, x:'Зниження σ температури дуття на кожні 10 °С',          c:'s', st:10,   u:'°С',  pg:-0.08, pt:-0.08, pr:0.13},
{t:'R', n:'К7', id:'k7', g:null, x:'Зниження σ вологості дуття на кожні 0,1 %',            c:'s', st:0.1,  u:'%',   pg:-0.45, pt:-0.45, pr:0.67},
{t:'R', n:'К8', id:'k8', g:null, x:'Зниження σ витрати природного газу на кожен 1 м\u00B3/т чав.', c:'s', st:1, u:'м\u00B3/т', pg:-0.42, pt:-0.42, pr:0.63},
{t:'R', n:'К9', id:'k9', g:null, x:'Зниження σ концентрації кисню в дутті на кожні 0,1 %',  c:'s', st:0.1,  u:'%',   pg:null,  pt:null,  pr:0.22},
];
    ...
    for (var i = 0; i < rows.length; i++) {
        ...
        switch (rd.c) {
            case 'p': // pair
                ...
                break;
            case 's': // single
                dCoke = (rd.pg != null ? rd.pg : 0) * val / step;
                dProd = (rd.pr != null ? rd.pr : 0) * val / step;
                break;
            case 'r': // replacement
                var saved = rd.rv * val;
